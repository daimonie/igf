...
data_current = np.log( np.abs( data_current ) ) / np.log(10.00)
 
 
tick_min = -9.7
tick_max = -6.7 

data_current[ data_current <= tick_min ] = tick_min
data_current[ data_current >= tick_max ] = tick_max
...
plt.savefig('perrin_experiment_abs.pdf')
